...
GridWithOther.args = {
  items: [
    { name: "Rei", field: "Computer Science", grade: 10 },
    { name: "Dave", field: "Biology", grade: 8 },
    { name: "Rei", field: "Computer Science", grade: 10 },
    { name: "Dave", field: "Biology", grade: 8 },
    { name: "Rei", field: "Computer Science", grade: 10 },
    { name: "Dave", field: "Biology", grade: 8 },
  ...
  renderItem: (item: any) => (
    <div className="my-4 p-3 flex flex-row justify-between items-center border-2 border-neutral-700 rounded-md">
