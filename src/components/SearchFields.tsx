...
export const SearchFields: React.FC<{findRepo: RefObject<HTMLInputElement>, findUser: RefObject<HTMLInputElement>, onChange: Function}> = ({findRepo, findUser, onChange}) => {

  return (
    <div className="flex flex-col md:flex-row gap-2 mt-2 mb-2">
      <input ref={findRepo} type="text" placeholder="Find a repo..." 
